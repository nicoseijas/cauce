...
Corre junto con build_red.py (no en el cron): build_estado.py usa este archivo
para no depender de geopandas en CI.
...
def main() -> None:
    ...
    out = join[[
        ...
        "HYRIV_ID", "DIS_AV_CMS", "codigo5", "dist_m", "join_ok", "geometry",
    ]].rename(columns={
